...
import requests
# Parte do conversor de Dólar para Real
...
def converter_dolar_para_real(dolar, taxa_cambio):
...
taxa_cambio = obter_cotacao_dolar()
real = converter_dolar_para_real(dolar, taxa_cambio)

print(f'Taxa de câmbio atual: R$ {taxa_cambio:.2f}')
